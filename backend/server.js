...
// ── Import routes ──
// NOTE: Use exact case matching your files on disk
...
// Subscription routes — NO gate (needed to check/pay)
// File on disk is: routes/Subscription.js  (capital S)
const subscriptionRoute = require('./routes/Subscription');
app.use('/api/subscription', subscriptionRoute.router);
